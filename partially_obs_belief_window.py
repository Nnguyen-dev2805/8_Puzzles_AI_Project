...
from algorithms import partially_observable_search

class PartiallyObsBeliefWindow:
    def __init__(self, parent):
        ...
        # Tiêu đề
        title_label = ttk.Label(self.window, text="Partially Observable Belief State Search", font=roboto_bold)
    ...
    def start_algorithm(self):
        ...
        algorithm = partially_observable_search.POMDPBeliefStateSearchAlgorithm()
        start_time = time.perf_counter()
        path, cost, counter, depth, time_taken, total_space = algorithm.POMDPBeliefStateSearch(
...
if __name__ == "__main__":
    root = tk.Tk()
    app = PartiallyObsBeliefWindow(root)
    root.mainloop()